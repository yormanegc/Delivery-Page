...
@section('content')
                ...
                <label class="my-1 mr-2" for="inlineFormCustomSelectPref">Preferencias</label>
                ...
                <div class="px-4 py-3  text-right sm:px-6">
                  ...
                  <a href="/history" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 h-8 w-24 " ><i class="fas fa-ban"></i></a>
                  <br>
